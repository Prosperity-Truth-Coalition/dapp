  ...
  abi: [
    {
      inputs: [
        ...
        { internalType: "uint8", name: "_d", type: "uint8" },
        { internalType: "uint256", name: "_ts", type: "uint256" },
        { internalType: "uint256", name: "_tax", type: "uint256" },
        { internalType: "uint256", name: "_bb", type: "uint256" },
        { internalType: "uint256", name: "_mkt", type: "uint256" },
        { internalType: "address", name: "_ma", type: "address" },
      ],
      stateMutability: "nonpayable",
      type: "constructor",
    },
...
export function humanFriendlyBalance(balance, decimals) {
  return (parseInt(balance) / 10 ** decimals).toFixed(3);
}

export function humanFriendlyBalanceWithFixed(balance, decimals,fixed) {
  return (parseInt(balance) / 10 ** decimals).toFixed(fixed);
}